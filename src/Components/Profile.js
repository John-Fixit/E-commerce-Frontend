...
function Profile() {
    ...
    const SAVEPROFILEURI = `${baseUrl}/user/save`
    const UPLOADURI = `${baseUrl}/user/uploadProfilePhoto`
    const GETUSERURI = `${baseUrl}/user/thisuser`
    const deleteAccURI = `${baseUrl}/user/deleteAccount`
    let userId

...
function SignUp() {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            contact: yup.string().required(`This field is requied`),
                        ...
                        <div className='p-3'>
                            ...
                            <form action='' onSubmit={formik.handleSubmit}>
                                <div className='row'>
                                    <div className='form-floating mt-2 col-lg-6 col-md-12'>
                                        <div className='form-floating'>
                                            <input type='text' name='firstname' className='form-control mx-auto' placeholder='First Name here' onChange={formik.handleChange} onBlur={formik.handleBlur} />
                                    ...
                                    <div className='form-floating mt-2 col-lg-6 col-md-12 '>
                                        <div className='form-floating '>
                                            <input type='text' name='lastname' className='form-control mx-auto' placeholder='Last Name here' onChange={formik.handleChange} onBlur={formik.handleBlur} />
                                ...
                                <div className='row'>
                                    ...
                                    <div className='form-floating mt-2 col-lg-6 col-md-12'>
                                        <div className='form-floating'>
                                            <input type='number' name='contact' className='form-control mx-auto bg-white' placeholder='Contact' onChange={formik.handleChange} onBlur={formik.handleBlur} />
                                ...
                                <div className='row'>
                                    ...
                                    <div className=' mt-2 col-lg-6 col-md-12'>
                                        <div className='form-floating'>
                                            <input type='text' name='username' className='form-control mx-auto' placeholder='username' onChange={formik.handleChange} onBlur={formik.handleBlur} />
